...
golem::fill_desc(
  ...
  authors =  c(person(
    ...
    family = "Lohmann", # Your Last Name
    email = "eugenie.lohmann@inserm.fr", # Your email
...
usethis::use_mit_license("Eugénie Lohmann") # You can set another license here
golem::use_readme_rmd(open = FALSE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Eugénie Lohmann")
...
golem::use_favicon(path = "/home/lohmann/FlowRepositoryQuery_old/inst/app/www/hex-query-8.png") # path = "path/to/ico". Can be an online file.
