...
golem::add_module(name = "textarea", with_test = TRUE) # Name of the module
# golem::add_module(name = "selectsize", with_test = TRUE) # Name of the module
...
# usethis::use_data_raw(name = "15_parse_keywords", open = FALSE)
